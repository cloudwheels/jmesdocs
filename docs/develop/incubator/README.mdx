...
Please signup to Incubator using our [Trello Board](http://jmes.art) and read the [Rules](./incubator-whitepaper) in our Whitepaper.
...
[JMES Incubator](https://incubator.jmes.art/) is a Decentralized Autonomous Organisation (DAO) that uses a micro-incentive bounty system to fund development of JMES projects by external subject experts.
