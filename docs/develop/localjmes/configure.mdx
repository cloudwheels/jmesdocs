...
LocalJmes is often used alongside[jmes.js](../jmes-js/README.mdx) scripting as it is a convenient environment in which to run integration tests. LocalJmes also allows developers to speed up the block time to improve the development experience.
