...
6\. Staking: The new set of active validators is determined from the top 100 bJMES stakers. Validators that lose their spot within the set start the unbonding process.
