...
Proposals start as ideas within the community on JMES's [Discord](https://discord.jmes.art/). After gaining support and feedback from the community, a proposer [drafts and submits a proposal](../../learn/terra-station/governance.mdx#create-a-new-proposal) alongside an [initial deposit](../../learn/terra-station/governance.mdx#deposit-bJMES-to-a-proposal). 
