...
Proposals start as ideas within the community on JMES's [Discord](https://discord.jmes.art/), please join the discussion there to find out more about the Propoal process.
